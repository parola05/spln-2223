...
def main():
    ...
    args_parser.add_argument('-t', '--translate', nargs='?', type=str, choices=['English', 'Spanish', 'French', 'German', 'Italian', 'Portuguese'], help='translate the book', const=['English'])
    ...
    args_parser.add_argument('-c', '--characters', action='store_true', help='get informations of the book characters')
    ...
    args_parser.add_argument('-p', '--projection', nargs=1, type=str, help='project queries in the text range. Projetion type is [<bottom>;<higher>]')
